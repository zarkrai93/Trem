...
QT_MOC_LITERAL(3, 16, 10), // "sairTrilho"
QT_MOC_LITERAL(4, 27, 12) // "entrarTrilho"

    },
    "Trem\0updateGUI\0\0sairTrilho\0entrarTrilho"
};
...
void Trem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sairTrilho((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->entrarTrilho((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Trem::sairTrilho)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Trem::entrarTrilho)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Trem::entrarTrilho(int _t1, int _t2)
{
